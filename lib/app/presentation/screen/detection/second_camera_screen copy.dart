...
class SecondCameraScreen extends StatefulWidget {
  ...
  const SecondCameraScreen({Key? key, required this.initialCamera})
      : super(key: key);

  @override
  _SecondCameraScreenState createState() => _SecondCameraScreenState();
}
              ...
              return Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "Buka lebar mulut anda, posisikan kamera anda diatas dan ambil foto bagian rahang gigi atas anda sesuai dengan pola",
