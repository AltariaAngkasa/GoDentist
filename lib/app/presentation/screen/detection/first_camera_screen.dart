...
class FirstCameraScreen extends StatefulWidget {
  final CameraDescription initialCamera;
  const FirstCameraScreen({Key? key, required this.initialCamera})
      : super(key: key);

  @override
  _FirstCameraScreenState createState() => _FirstCameraScreenState();
}

class _FirstCameraScreenState extends State<FirstCameraScreen> {
  ...
  Future<XFile?> capturePhoto() async {
    ...
    try {
      await _controller
          .setFlashMode(_flashMode); // Set flash mode before taking a picture
              ...
              return Column(
                children: [
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      icon: Icon(
                                        _flashMode == FlashMode.off
                                            ? Icons
                                                .flash_off_sharp // Ubah ikon menjadi flash off jika _flashMode adalah off
                                            : Icons
                                                .flash_on_sharp, // Ubah ikon menjadi flash on jika _flashMode adalah on
                                        size: 24.0,
                                        color: Colors.white,
                                      ),
                                    ),
                  ...
                  Container(
                    ...
                    child: Text(
                      "Buka lebar mulut anda, posisikan kamera anda didepan dan ambil foto bagian rahang gigi depan anda sesuai dengan pola",
